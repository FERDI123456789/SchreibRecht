      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              "group/sidebar-wrapper flex min-h-svh w-full has-[[data-variant=inset]]:bg-primary/20",
              className,
            )}
            ref={ref}
            {...props}
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-2 overflow-auto rounded-lg bg-white shadow-sm group-data-[collapsible=icon]:overflow-hidden",
        className,
      )}
      {...props}
    />
