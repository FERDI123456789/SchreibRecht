    ...
    <div className="flex h-full w-full flex-col justify-between">
      <div className="flex justify-between gap-6">
        ...
        <div className="flex items-center justify-center">
          <Avatar className="ringtransition-all group relative mr-[12px] h-32 w-32 rounded-full ring ring-black duration-200">
            <AvatarImage
            ...
            <div className="absolute bottom-10 left-10 z-20 flex h-12 w-12 items-center justify-center rounded-full bg-black opacity-0 group-hover:opacity-100">
              <Edit />
            </div>
          </Avatar>
          <div className="">
      ...
      <div className="w-full space-y-3 py-6">
        ...
        <div className="h-4 w-full overflow-hidden rounded-full border border-black shadow-inner">
          <div
            className="h-full bg-gradient-to-r from-black to-black/60 transition-all duration-500"
