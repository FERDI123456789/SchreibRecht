            ...
            <ul className="grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
              <li className="row-span-3">
                <NavigationMenuLink asChild>
                  <a
                    className="flex h-full w-full select-none flex-col justify-end rounded-md bg-gray-100 hover:bg-primary/10 p-6 no-underline outline-none hover:shadow-md hover:-translate-y-1 focus:shadow-md focus:-translate-y-1 active:translate-y-0 transition-all duration-200"
                    href="/"
                  >
          ...
          <NavigationMenuContent>
            <ul className="grid gap-3 p-4 md:w-[70%] md:grid-cols-4 md:grid-rows-3 lg:w-[900px] ">
              <li className="row-span-3 col-span-2">
                <NavigationMenuLink asChild>
                  <a
                    className="flex h-full w-full select-none flex-col justify-end rounded-md bg-gray-100 p-6 no-underline outline-none hover:bg-black hover:text-white hover:shadow-md hover:shadow-black hover:-translate-y-1 focus:shadow-md focus:shadow-black focus:bg-black focus:text-white focus:-translate-y-1 active:translate-y-0 transition-all duration-200"
                    href="/"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" className=' size-9 inline-block' viewBox="0 0 24 24">
    ...
    <li>
      <NavigationMenuLink asChild>
        <a
          ref={ref}
          className={cn(
            "block select-none space-y-1 p-3 leading-none no-underline outline-none hover:bg-primary/10 hover:shadow-md hover:-translate-y-1 focus:shadow-md focus:bg-gray-100 focus:-translate-y-1 active:translate-y-0 rounded-md   transition-all duration-200",
            className
          )}
          {...props}
        >
          <div className="text-sm font-medium leading-none">{Icon && <Icon className="size-4 inline-block mr-1"/>} {title}</div>
